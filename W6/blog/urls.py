...
from .views import index_blog, ArticleDetail, SearchArticle, ArticleList, CreateArticleView, UpdateArticleView, hello
...
urlpatterns = [
    ...
    path('<str:slug>/update', UpdateArticleView.as_view(), name='update-article'),
    path('hello', hello),
]
